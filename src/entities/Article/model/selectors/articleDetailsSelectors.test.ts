...
import { getArticleDetailsData, getArticleDetailsError, getArticleDetailsLoading } from './articleDetailsSelectors';
  ...
  blocks: [
    {
      ...
      paragraphs: [
        ...
        средствами JavaScript, приведённый на этом ресурсе. Этот пример можно 
        запустить и средствами данного ресурса (ищите кнопку Try it Yourself), 
...
describe('articleDetailsSelector', () => {
  ...
  test('Should return false', () => {
    ...
    expect(getArticleDetailsLoading(state as StateSchema)).toBe(false);
  });
