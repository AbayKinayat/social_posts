...
describe('articleDetails', () => {
  test('fetchArticleDetail pending', () => {
  ...
  test('fetchArticleDetail fulfilled', () => {
    const state: DeepPartial<ArticleDetailsSchema> = {
      data: undefined,
    };
    ...
    expect(articleDetailsReducer(
      state as ArticleDetailsSchema,
      fetchArticleDetail.fulfilled(testData, '', ''),
    )).toEqual({
      data: testData,
      error: '',
      isLoading: false,
  ...
  test('fetchArticleDetail rejected', () => {
    const state: DeepPartial<ArticleDetailsSchema> = {
      error: '',
    };
    expect(
      articleDetailsReducer(
        state as ArticleDetailsSchema,
        fetchArticleDetail.rejected(new Error(), '', '', 'error'),
      ),
    ).toEqual({
      error: 'error',
      isLoading: false,
