...
import { fetchArticleDetail } from './fetchArticleDetail';
...
describe('fetchArticleDetail', () => {
  test('fetchArticleDetail success', async () => {
    ...
    const thunk = new TestAsyncThunk(fetchArticleDetail, state);
  ...
  test('fetchArticleDetail error', async () => {
    const state: DeepPartial<StateSchema> = {
      articleDetails: {},
    };
